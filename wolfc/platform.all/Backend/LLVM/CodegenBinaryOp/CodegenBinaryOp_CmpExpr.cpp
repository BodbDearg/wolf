...
WC_IMPL_PTR_CMP_OP(CodegenCmpEQBinaryOp, Nullptr, CreateICmpEQ, "CmpEQ")
WC_IMPL_PTR_CMP_OP(CodegenCmpEQBinaryOp, Ptr, CreateICmpEQ, "CmpEQ")
...
WC_IMPL_PTR_CMP_OP(CodegenCmpNEBinaryOp, Nullptr, CreateICmpNE, "CmpNE")
WC_IMPL_PTR_CMP_OP(CodegenCmpNEBinaryOp, Ptr, CreateICmpNE, "CmpNE")
...
WC_IMPL_PTR_CMP_OP(CodegenCmpLTBinaryOp, Nullptr, CreateICmpSLT, "CmpLT")
WC_IMPL_PTR_CMP_OP(CodegenCmpLTBinaryOp, Ptr, CreateICmpSLT, "CmpLT")
...
WC_IMPL_PTR_CMP_OP(CodegenCmpLEBinaryOp, Nullptr, CreateICmpSLE, "CmpLE")
WC_IMPL_PTR_CMP_OP(CodegenCmpLEBinaryOp, Ptr, CreateICmpSLE, "CmpLE")
...
WC_IMPL_PTR_CMP_OP(CodegenCmpGTBinaryOp, Nullptr, CreateICmpSGT, "CmpGT")
WC_IMPL_PTR_CMP_OP(CodegenCmpGTBinaryOp, Ptr, CreateICmpSGT, "CmpGT")
...
WC_IMPL_PTR_CMP_OP(CodegenCmpGEBinaryOp, Nullptr, CreateICmpSGE, "CmpGE")
WC_IMPL_PTR_CMP_OP(CodegenCmpGEBinaryOp, Ptr, CreateICmpSGE, "CmpGE")
