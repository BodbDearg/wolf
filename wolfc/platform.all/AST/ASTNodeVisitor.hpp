...
class PrimaryExprNullLit;
class PrimaryExprParen;
class PrimaryExprRandExpr;
class PrimaryExprReadnumExpr;
class PrimaryExprStrLit;
class PrimaryExprTimeExpr;
class PrimitiveType;
class PrintStmnt;
class RandExprRand;
class RandExprSRand;
...
public:
    ...
    virtual void visit(const AssignExprAssignRem & astNode) = 0;
    ...
    virtual void visit(const MulExprRem & astNode) = 0;
    ...
    virtual void visit(const NullLit & astNode) = 0;
    ...
    virtual void visit(const PrefixExprPtrDenull & astNode) = 0;
    ...
    virtual void visit(const PrimaryExprNullLit & astNode) = 0;
    virtual void visit(const PrimaryExprParen & astNode) = 0;
    virtual void visit(const PrimaryExprRandExpr & astNode) = 0;
    virtual void visit(const PrimaryExprReadnumExpr & astNode) = 0;
    virtual void visit(const PrimaryExprStrLit & astNode) = 0;
    virtual void visit(const PrimaryExprTimeExpr & astNode) = 0;
