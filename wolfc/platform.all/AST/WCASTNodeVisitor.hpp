...
public:
    ...
    virtual void visit(const AddExprTwoOps & astNode) = 0;
    ...
    virtual void visit(const AssignExprAssignBase & astNode) = 0;
    ...
    virtual void visit(const AssignExprBinaryOpBase & astNode) = 0;
    ...
    virtual void visit(const CmpExprTwoOps & astNode) = 0;
    ...
    virtual void visit(const MulExprTwoOps & astNode) = 0;
    ...
    virtual void visit(const PostfixExprIncDecBase & astNode) = 0;
    ...
    virtual void visit(const ReturnStmntWithCondBase & astNode) = 0;
    ...
    virtual void visit(const ShiftExprTwoOps & astNode) = 0;
    ...
    virtual void visit(const UnaryExprPlusMinusBase & astNode) = 0;
