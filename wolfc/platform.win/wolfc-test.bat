...
@SET LIB=%MSVC_DIR%\LIB;%MSVC_DIR%\ATLMFC\LIB;C:\Program Files (x86)\Windows Kits\10\lib\10.0.14393.0\ucrt\x64;C:\Program Files (x86)\Windows Kits\NETFXSDK\4.6.1\lib\um\x64;C:\Program Files (x86)\Windows Kits\10\lib\10.0.14393.0\um\x64;
...
@lld-link "wolfc-test\wolfc-test.o"
